...
func (m *MockConfigClient) DeleteConnection(_ string) error { return m.DeleteConnectionError }
func (m *MockConfigClient) AddFavorite(_ string, _, _ string) (types.Favorite, error) {
	return m.AddFavoriteResult, m.AddFavoriteError
}
func (m *MockConfigClient) RemoveFavorite(_ string, _ string) error                { return m.RemoveFavoriteError }
func (m *MockConfigClient) ListFavorites(_ string) []types.Favorite                { return m.ListFavoritesResult }
func (m *MockConfigClient) IsFavorite(_ string, _ string) bool                     { return m.IsFavoriteResult }
func (m *MockConfigClient) AddRecentKey(_ string, _ string, _ types.KeyType)       {}
func (m *MockConfigClient) ListRecentKeys(_ string) []types.RecentKey              { return m.ListRecentKeysResult }
func (m *MockConfigClient) ClearRecentKeys(_ string)                               {}
...
func (m *MockConfigClient) AddConnectionToGroup(_ string, _ string) error {
	return m.AddConnectionToGrpError
}

func (m *MockConfigClient) RemoveConnectionFromGroup(_ string, _ string) error {
	return m.RemoveConnFromGrpError
}
